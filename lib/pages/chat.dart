...
class _ChatPageState extends State<ChatPage> {
  ...
  void getAnswer() async {
    const url = "https://generativelanguage.googleapis.com/v1beta2/models/chat-bison-001:generateMessage?key=AIzaSyAucl9t6BZXAjWZswDeAuVPn4uaewRGJh4";
                  ...
                  child: Align(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: (_chatHistory[index]["isSender"]?Colors.deepPurple:Colors.white),
                      ),
